(() => {
  ...
  function normalizeProjects(projects = []) {
    return (Array.isArray(projects) ? projects : []).map((project) => ({
      ...
      allowedOrigins: Array.isArray(project.allowed_origins) ? project.allowed_origins : project.allowed_origins === "*" ? ["*"] : String(project.allowed_origins || "").split(",").map((value) => value.trim()).filter(Boolean)
    }));
  }
  ...
  (function() {
    ...
    function ProjectList({ projects, selectedProject, onSelect }) {
      return React.createElement(
        ...
        projects.map((project) => {
          ...
          return React.createElement(
            "div",
            { className: "aa-hermes-project-row", key: project.id || project.name },
            React.createElement(
              "div",
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            kpis.map((card) => React.createElement(
              "div",
              { className: "aa-hermes-kpi", key: card.label },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              CardContent,
              { className: "aa-hermes-stack aa-hermes-stack-tight" },
              topPages.length ? topPages.map((row, index) => React.createElement(
                "div",
                { className: "aa-hermes-list-row", key: `${row.path || row.page || "page"}-${index}` },
          ...
          React.createElement(
            ...
            React.createElement(
              CardContent,
              { className: "aa-hermes-stack aa-hermes-stack-tight" },
              topEvents.length ? topEvents.map((row, index) => React.createElement(
                "div",
                { className: "aa-hermes-list-row", key: `${row.event}-${index}` },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              CardContent,
              { className: "aa-hermes-stack aa-hermes-stack-tight" },
              insights.length ? insights.map((item, index) => React.createElement(
                "div",
                { className: "aa-hermes-insight", key: `insight-${index}` },
          ...
          React.createElement(
            ...
            React.createElement(
              CardContent,
              { className: "aa-hermes-stack aa-hermes-stack-tight" },
              recentEvents.length ? recentEvents.map((event, index) => React.createElement(
                "div",
                { className: "aa-hermes-event", key: `${event.event || "event"}-${index}` },
    ...
    function AgentAnalyticsPage() {
      ...
      function handleSelectProject(projectId) {
        postJSON(PROJECT_SELECT_URL, { project_id: projectId }).then((data) => setStatus(data)).catch((err) => setError(err.message || "Failed to select project."));
      }
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "div",
              { className: "aa-hermes-stack aa-hermes-stack-tight" },
              React.createElement("p", { className: "aa-hermes-kicker" }, "Hermes Dashboard Plugin"),
              React.createElement(CardTitle, { className: "aa-hermes-title" }, "Agent Analytics"),
              React.createElement("span", { className: "aa-hermes-muted" }, "Dashboard-only read plugin for Hermes")
            ),
            status && status.auth && status.auth.connected ? React.createElement(Badge, { variant: "outline", className: "aa-hermes-badge" }, status.auth.tier || "connected") : null
          ),
          React.createElement(
            CardContent,
            { className: "aa-hermes-stack aa-hermes-stack-tight" },
            status && status.auth && status.auth.connected ? React.createElement(
              "div",
        ...
        view === "project-selection" ? React.createElement(
          EmptyState,
          {
        ...
        ) : React.createElement(SummaryView, { summary: summary || {}, selectedProject: status.selectedProject, onRefresh: loadSummary }) : null
      );
    }
